...
// Converted from aorboweb/templates/emails/other.html
// Reference/preview component only — see note in EmailLayout.jsx.
export default function OtherInquiryEmail({ message, name, email, currentYear }) {
              ...
              <tbody>
                ...
                <tr>
                  <td style={{ paddingTop: 25, color: '#333', lineHeight: 1.6, fontSize: 15 }}>
                    ...
                    <p>
                      Thank you for reaching out to <strong>Aorbo Treks</strong>. We've received
                      your message and our team will review it shortly.
                    </p>
                    <p>We'll get back to you with the best possible response based on your query.</p>
                ...
                <tr>
                  <td style={{ background: '#f4f7fe', padding: 30, textAlign: 'center' }}>
                    ...
                    <p style={{ marginTop: 14, fontSize: 12, color: '#aaa' }}>
                      This is an auto-generated email sent to <strong>{email}</strong>.
                    </p>
                  </td>
                </tr>
              </tbody>
